...
**উত্তর:** Variable-এর Data Type জানার জন্য।

### typeof passed এর Output কী হবে, যদি passed = false হয়?

**উত্তর:** `boolean`

### "Bangladesh" কোন Data Type?
...
### console.log(typeof price); কী দেখায়?

**উত্তর:** price Variable-এর Data Type।

### String Value কীসের মধ্যে থাকে?

**উত্তর:** Quotation-এর মধ্যে।

### Boolean Value কী কী হতে পারে?
...
**উত্তর:** যে Variable-এর মান পরে Change হতে পারে, সেটি Declare করতে।

### const কী বোঝায়?

**উত্তর:** Fixed বা Constant Value।

### const Variable-এর Value Change করলে কী হয়?

**উত্তর:** Error হয়।

### let price = 35; price = 45; এর Output কী?

**উত্তর:** `45`

### Value Update করার সময় আবার let লিখতে হয়?

**উত্তর:** না।

### Assignment to constant variable Error কখন হয়?

**উত্তর:** const Variable-এর Value Change করতে গেলে।

### Changeable Value-এর জন্য কোন Keyword ব্যবহার করা হয়?

**উত্তর:** `let`

### Fixed Value-এর জন্য কোন Keyword ব্যবহার করা হয়?
...
**উত্তর:** কোডের মধ্যে লেখা ব্যাখ্যা বা নোট।

### Comment কি Execute হয়?

**উত্তর:** না।

### Comment কি Output দেয়?

**উত্তর:** না।

### Single-Line Comment কীভাবে লেখা হয়?
...
### Comment কেন ব্যবহার করা হয়?

**উত্তর:** Code বোঝার সুবিধার জন্য।

### কোনো Code সাময়িকভাবে বন্ধ করতে কী ব্যবহার করা যায়?
...
**উত্তর:** এটি একটি Single-Line Comment।

### Comment কে দেখে?

**উত্তর:** Developer বা Programmer।

### Comment-এর প্রধান সুবিধা কী?

**উত্তর:** Code সহজে বুঝতে ও Maintain করতে সাহায্য করে।
...
### Variable Name-এ Space ব্যবহার করা যায়?

**উত্তর:** না।

### Variable Name কি Number দিয়ে শুরু করা যায়?

**উত্তর:** না।

### Variable Name কি Case-Sensitive?

**উত্তর:** হ্যাঁ।

### city এবং City কি একই Variable?

**উত্তর:** না, আলাদা।

### JavaScript-এ কোন Naming Style Recommended?

**উত্তর:** camelCase

### Reserved Keyword Variable Name হিসেবে ব্যবহার করা যায়?

**উত্তর:** না।

### Variable Name-এ কোন Special Character ব্যবহার করা যায়?

**উত্তর:** `_` এবং `$`

### `const 3money = 45;` সঠিক নাকি ভুল?

**উত্তর:** ভুল।

### `const money3 = 45;` সঠিক নাকি ভুল?

**উত্তর:** সঠিক।

### ভালো Variable Name কেমন হওয়া উচিত?

**উত্তর:** অর্থপূর্ণ ও সহজে বোঝা যায় এমন।
...
**উত্তর:** String-কে Integer Number-এ Convert করে।

---

### parseFloat() কী করে?

**উত্তর:** String-কে Decimal Number-এ Convert করে।

---

### `"50" + "20"` এর Output কী হবে?

**উত্তর:** `5020`

---

### parseInt("50f") এর Output কী?

**উত্তর:** `50`

---

### parseInt("tom60") এর Output কী?

**উত্তর:** `NaN`

---

### parseInt("1.22222") এর Output কী?

**উত্তর:** `1`

---

### parseFloat("1.22222") এর Output কী?
...
**উত্তর:** Decimal-এর পরে ২ ঘর পর্যন্ত দেখায়।

---

### toFixed() এর Output কোন Type হয়?

**উত্তর:** `string`

---

### parseInt() এবং parseFloat() এর মধ্যে পার্থক্য কী?

**উত্তর:** `parseInt()` পূর্ণসংখ্যা নেয়, আর `parseFloat()` Decimal Number নেয়।

---

### NaN কখন আসে?

**উত্তর:** যখন কোনো Value-কে Number-এ Convert করা সম্ভব হয় না।

---

### Number হিসেবে ব্যবহার করতে চাইলে toFixed() এর Result-এর উপর কী করতে হবে?

**উত্তর:** `parseFloat()` ব্যবহার করতে হবে।
